    ...
    <div>
      <div class="row">
        <div>
          <div class="logo-thumbnail">
            <a href="https://github.com/thakurujjwal/react-mi-clone">
              <img src="/images/myphoto2.jpg" alt="logo-img" />
            </a>
            <span> dvlpujjwal</span>
          </div>
          <div>
            <p className="footer-p">Find with me</p>
      ...
      <div class="copyright ">
        <p class="description footer">
          {" "}
          © 2021. All rights reserved by <span><i>ujjwal thakur</i></span>
        </p>
      </div>
    </div>
  );
